...
* Оценки по Лаборатории практики:
  - Результаты лабораторной работы можно проверить в файле **Final_Scores_Algorithms_Programming.xlsx**   
     
* Список выдающихся студентов:   
  Поздравляем с вашим профессионализмом и усердной работой!!! Особое признание тем студентам, которые работали серьезно и очень профессионально!    
  В этот список вошли лучшие студенты из каждой группы:
  
                                                   ---- *Группа 40001:* ----    
  - Чеботарев Сергей Александрович   
  - Тихонов Андрей Русланович  
  - Киричек Мария Романовна
  
                                                  ---- *Группа 40002:* ----      
  - Сикорский Александр Владимирович   
  - Мартьянов Иван Константин   
  - Чиканге Майкл  
...
**Тема: Упрощенное моделирование системы транзакций BlockChain**   
  ...
  ![image](https://github.com/user-attachments/assets/5a9bbdc3-5a45-4921-8183-00690ce50199)   
...
* В день презентации (определенной в сессия экзаменов) все 4 участника каждой группы должны представить:  
    - систему на C++ OOP, запущенную на локальном компьютере, следуя указаниям документа **kursovaya_rabota/project_end_course_ru.pdf**   
    - отчет в формате pdf, следуя инструкциям документа **kursovaya_rabota/kursovaya_requirements.pdf**   
    - Отчет каждой группы должен быть представлен в печатном виде в день доклада курсовая работа.   
